...
import subprocess
import ryno
from ryno.utils import get_version, send_discord_alert

webhook_url = ""
current_version = ryno.__version__
...
if __name__ == "__main__":
    ...
    parser.add_argument("--netuid", required=False, default=224, help="netuid for validator")
